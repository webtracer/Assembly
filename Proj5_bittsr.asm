TITLE Random Number Generator and Dispaly     (Proj5_bittsr.asm)

; Author: Randy Bitts
; Last Modified: 03/05/23
; OSU email address: bittsr@oregonstate.edu
; Course number/section:   CS271 Section 400
; Project Number:  5               Due Date: 03/05/2023
; Description: Program generates arrays of random numbers, sorts them in order, 
;              and finds the median of the sorted array
